...
export default function FiltrocerPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="px-4 md:px-8 py-10 md:py-14 bg-gradient-to-b from-[#CAF0F8] to-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-[#0077B6] mb-2">
            Algunos de nuestros equipos
          </h2>
          <p className="text-center text-gray-600 text-sm sm:text-base mb-6 md:mb-8">
            Toca cualquier imagen para ver el catálogo completo
          </p>
      ...
      {/* SECCIÓN 2: HERO */}
      <section className="px-4 md:px-8 py-10 md:py-20 text-center bg-white">
