          ...
          <div className="overflow-x-auto pb-8 -mx-4 px-4 snap-x snap-mandatory" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            ...
            <div className="flex gap-4 sm:gap-6 min-w-min pb-6">
              {products.map((product) => (
                <div
                  key={product._id}
                  className="flex-shrink-0 w-[85vw] sm:w-[22rem] lg:w-[24rem] flex flex-col sm:flex-row rounded-2xl overflow-hidden transition-all duration-500 group cursor-pointer border relative snap-start"
                  style={{ 
                ...
                >
                  {/* Product Image */}
                  <div className="relative overflow-hidden w-full sm:w-[45%] h-56 sm:h-auto min-h-[14rem] flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-4">
                  ...
                  {/* Product Info */}
                  <div className="p-4 sm:p-5 flex flex-col justify-between flex-grow bg-white w-full sm:w-[55%] border-t sm:border-t-0 sm:border-l border-slate-100">
                    <div className="mb-3">
                      <h4 className="font-bold text-base sm:text-md leading-tight mb-1.5 group-hover:text-[#0077B6] transition-colors duration-300 line-clamp-2" style={{ color: 'rgb(15, 23, 42)' }}>
                        {product.name}
                      </h4>
                    ...
                    <div className="mt-auto pt-2">
                        {/* Price */}
                        <div className="mb-4">
                          <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-slate-400 mb-1">Inversión</p>
