    ...
    <section className="pt-6 pb-16 md:pt-10 md:pb-24 px-4 relative overflow-hidden" style={{ backgroundColor: 'rgb(248, 250, 252)' }}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <nav className="mb-6 flex items-center gap-2 text-sm text-gray-500">
          <a href="/" className="flex items-center gap-1 text-[#0077B6] hover:underline font-medium">
        ...
        {products.length === 0 ? (
          <div className="text-center py-16 px-4">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Catálogo en construcción</h3>
            <p className="text-gray-500 mb-6 max-w-sm mx-auto">
              Estamos cargando nuestros productos. Escríbenos por WhatsApp para ver los equipos disponibles.
            </p>
            <a
              href="https://wa.me/573116835639?text=Hola,%20quisiera%20ver%20el%20catálogo%20de%20equipos"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 text-white bg-[#25D366] rounded-full hover:bg-[#20bd5a] hover:scale-105 transition-all font-bold text-sm shadow-md"
            >
